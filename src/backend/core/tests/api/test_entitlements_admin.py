...
@pytest.mark.parametrize("account_key,account_key_value,account_key_http_alias", [["external_id", "xyz", "id"], ["email", "test@example.com", "email"]])
def test_api_entitlements_is_admin_false_no_account(account_key, account_key_value, account_key_http_alias):
...
@pytest.mark.django_db()
@pytest.mark.parametrize("account_key,account_key_value,account_key_http_alias", [["external_id", "xyz", "id"], ["email", "test@example.com", "email"]])
def test_api_entitlements_is_admin_false_no_admin_role(account_key, account_key_value, account_key_http_alias):
    """Test the is_admin entitlement for a user entitlement."""
...
@pytest.mark.django_db()
@pytest.mark.parametrize("account_key,account_key_value,account_key_http_alias", [["external_id", "xyz", "id"], ["email", "test@example.com", "email"]])
def test_api_entitlements_is_admin_true_organization_level(account_key, account_key_value, account_key_http_alias):
    """Test the is_admin entitlement for a user entitlement."""
...
@pytest.mark.django_db()
@pytest.mark.parametrize("account_key,account_key_value,account_key_http_alias", [["external_id", "xyz", "id"], ["email", "test@example.com", "email"]])
def test_api_entitlements_is_admin_true_service_level(account_key,  account_key_value, account_key_http_alias):
    """Test the is_admin entitlement for a user entitlement."""
