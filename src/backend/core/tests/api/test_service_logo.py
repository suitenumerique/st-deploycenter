...
class TestServiceLogoViewSet:
    ...
    def test_get_service_logo_unicode_content(self, api_client):
        ...
        svg_content = '<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><text x="50" y="50" text-anchor="middle">Testé</text></svg>'.encode('utf-8')
        service = factories.ServiceFactory(
            is_active=True,
            logo_svg=svg_content
        )
