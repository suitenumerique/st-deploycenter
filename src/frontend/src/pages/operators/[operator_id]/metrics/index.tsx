...
export default function MetricsPage() {
  ...
  const chartData = useMemo(() => {
    ...
    const convert = (raw: string) => {
      ...
      return unit ? parsed / UNIT_DIVISORS[unit] : parsed;
    };
  ...
  }, [metricsData, isAggregated, isGroupedByOrg, t, unit]);
            ...
            items={[
              {
                content: (
                  <button
                    ...
                    onClick={() =>
                      router.push(`/operators/${operatorId}/metrics`)
                    }
                  >
                    <Icon name="bar_chart" />
                    {t("metrics.title")}
            ...
            <ResponsiveContainer width="100%" height={chartHeight}>
              ...
              >
                <XAxis
                  ...
                  label={{
                    value: unit
                      ? `${t("metrics.chart.value_axis")} (${unit})`
